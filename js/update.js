function dptPop(year){
	...
	var color = d3.scale.threshold()
	    .domain([minPop,minPop+1*(maxPop-minPop)/(1000),minPop+2*(maxPop-minPop)/(1000),minPop+3*(maxPop-minPop)/(1000),minPop+4*(maxPop-minPop)/(1000),minPop+5*(maxPop-minPop)/(1000),minPop+6*(maxPop-minPop)/(1000),minPop+7*(maxPop-minPop)/(1000),minPop+8*(maxPop-minPop)/(1000),minPop+20*(maxPop-minPop)/(1000),minPop+40*(maxPop-minPop)/(1000),maxPop])
